...
◎配送先<!--{if count($arrShipping) > 1}--><!--{$smarty.foreach.shipping.iteration}--><!--{/if}-->
...
使用ポイント　<!--{$arrOrder.use_point|default:0|number_format}-->pt
加算ポイント　<!--{$arrOrder.add_point|default:0|number_format}-->pt
所持ポイント　<!--{$arrCustomer.point|default:0|number_format}-->pt
<!--{/if}-->
