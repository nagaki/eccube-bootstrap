...
<body>
  ...
  <div class="container">
    ...
    <!--{assign var=index value=$smarty.const.TOP_URLPATH|cat:'index.php'}-->
    <!--{if $smarty.server.PHP_SELF != $index}-->
    <!--{* パンくずリスト *}-->
    <ul class="breadcrumb">
      <li><a href="<!--{$smarty.const.TOP_URLPATH}-->" title="ホームへ">ホーム</a>&nbsp;<span class="divider">/</span></li>
      <li><!--{$tpl_title|h}--></li>
    </ul>
    <!--{/if}-->
    ...
    <div id="container-wrapper" class="row">
      ...
      <div
        <!--{if $tpl_column_num == 3}-->
        id="three_maincolumn" class="span6 main_column"
      ...
      <div id="bottomcolumn" class="span12">
        <!--{* ▼下ナビ *}-->
