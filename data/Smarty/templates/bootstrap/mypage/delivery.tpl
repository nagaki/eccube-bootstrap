...
<div id="mypagecolumn">
  ...
  <div id="mycontents_area">
    ...
    <!--{* 退会時非表示 *}-->
    <!--{if $tpl_login}-->
    <a class="btn btn-default" href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php" onclick="eccube.openWindow('./delivery_addr.php','delivadd','600','640',{menubar:'no'}); return false;" target="_blank">新しいお届け先を追加</a>
    <!--{/if}-->
    <!--{/if}-->
