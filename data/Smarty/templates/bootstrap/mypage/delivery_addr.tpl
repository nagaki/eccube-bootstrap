...
<section class="page-body" id="mypage-delivery-add-area">
  <header>
    <h1><!--{$tpl_title|h}--></h1>
  </header>
  <article id="mypage-delivery-add-contents">
    <form class="form-horizontal" name="form1" id="form1" method="post" action="?">
      ...
      <footer class="form-actions">
        <button class="btn btn-primary" type="submit" name="register" id="register">登録する</button>
      </footer>
    </form>
  </article>
</section>
