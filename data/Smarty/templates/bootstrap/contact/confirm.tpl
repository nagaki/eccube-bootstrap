...
<section class="page-body" id="contact-confirm-area">
  <header>
    <h1><!--{$tpl_title|h}--></h1>
  </header>
  <article id="contact-confirm-contents">
    <div class="alert alert-info">
      下記入力内容で送信してもよろしいでしょうか？
    </div>
    <form name="form1" id="form1" method="post" action="?">
      ...
      <div class="form-actions">
        <a class="btn" ref="?" onclick="fnModeSubmit('return', '', ''); return false;" id="back02">戻る</a>
        <button class="btn btn-primary" type="submit" name="send" id="send">お問い合わせを送信する</button>
      </div>
    </form>
  </article>
</section>