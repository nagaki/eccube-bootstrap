...
<div id="undercolumn">
  <div id="undercolumn_shopping">
    ...
    <div class="alert alert-info">
      <p>下記ご注文内容で送信してもよろしいでしょうか？よろしければ、<strong>「<!--{if $use_module}-->次へ<!--{else}-->ご注文完了ページへ<!--{/if}-->」ボタン</strong>をクリックしてください。</p>
    </div>
    ...
    <form name="form1" id="form1" method="post" action="?">
      ...
      <div class="btn_area">
        <a class="btn btn-default" href="./payment.php">戻る</a>
        <!--{if $use_module}-->
        <input class="btn btn-default" type="submit" onclick="return fnCheckSubmit();" value="次へ" name="next-top" id="next-top" />
        <!--{else}-->
        <input class="btn btn-default" type="submit" onclick="return fnCheckSubmit();" value="ご注文完了ページへ" name="next-top" id="next-top" />
        <!--{/if}-->
      </div>
      ...
      <div class="btn_area">
        <a class="btn btn-default" href="./payment.php" name="back<!--{$key}-->" >戻る</a>
        <!--{if $use_module}-->
        <input class="btn btn-default" type="submit" onclick="return fnCheckSubmit();" value="次へ" name="next" id="next" />
        <!--{else}-->
        <input class="btn btn-default" type="submit" onclick="return fnCheckSubmit();" value="ご注文完了ページへ"  name="next" id="next" />
        <!--{/if}-->
      </div>
    </form>
  </div>
