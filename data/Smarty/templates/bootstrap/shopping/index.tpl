       ...
       <div class="login_area">
         ...
         <div class="inputbox">
           <div class="form-group">
             ...
             <label>メールアドレス</label>
             <input class="form-control" type="text" name="<!--{$key}-->" value="<!--{$tpl_login_email|h}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->; ime-mode: disabled;" />
           ...
           <div class="form-group">
             ...
             <label>パスワード</label>
             <input class="form-control" type="password" name="<!--{$key}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" />
             <span class="attention"><!--{$arrErr[$key]}--></span>
           </div>
           <input type="submit" class="btn btn-default" value="ログイン" name="log" id="log" />
         </div>
         <p>
