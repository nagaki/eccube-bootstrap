   ...
   <div id="undercolumn_shopping">
     ...
     <div id="address_area">
       ...
       <div class="add_multiple">
         ...
         <a class="btn btn-default" href="javascript:;" onclick="eccube.setModeAndSubmit('multiple', '', ''); return false">
           お届け先を複数指定する
         </a>
       </div>
       <!--{/if}-->
     ...
     <!--{if $tpl_addrmax < $smarty.const.DELIV_ADDR_MAX}-->
     <p class="addbtn">
       <a class="btn btn-default" href="<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php" onclick="eccube.openWindow('<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php?page=<!--{$smarty.server.SCRIPT_NAME|h}-->','new_deiv','600','640'); return false;">
         新しいお届け先を追加する
       </a>
     </p>
     <!--{/if}-->
     ...
     <form name="form1" id="form1" method="post" action="?">
       ...
       <div class="btn_area">
         <a class="btn btn-default" href="<!--{$smarty.const.CART_URL}-->">戻る</a>
         <input class="btn btn-default" type="submit" value="選択したお届け先に送る" name="send_button" id="send_button" />
       </div>
