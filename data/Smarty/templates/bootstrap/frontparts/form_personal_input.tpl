...
<fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <!--{/if}-->
      <input type="text" id="customer-surname" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="input-small required" placeholder="姓" x-autocompletetype="surname" autofocus>
      <input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="input-small required" placeholder="名" x-autocompletetype="given-name">
    </div>
  </div>
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
      <!--{/if}-->
      <input type="text" id="customer-surname-kana" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="input-small required" placeholder="セイ">
      <input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="input-small required" placeholder="メイ">
    </div>
  </div>
</fieldset>
<fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
      <!--{/if}-->
      <input type="text" id="customer-postal-code" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$smarty.const.ZIP01_LEN}-->" class="input-mini required">&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$smarty.const.ZIP02_LEN}-->" class="input-mini required">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <label class="inline require-label"><input type="text" name="<!--{$key4}-->" value="<!--{$arrForm[$key4].value|h}-->" class="required" placeholder="<!--{$smarty.const.SAMPLE_ADDRESS1}-->"> 市町村名</label>
      <label class="inline"><input type="text" name="<!--{$key5}-->" value="<!--{$arrForm[$key5].value|h}-->" placeholder="<!--{$smarty.const.SAMPLE_ADDRESS2}-->"> 番地・マンション名</label>
...
<fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <!--{/if}-->
      <input id="customer-tel" type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="input-mini required">&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="input-mini required">&nbsp;-&nbsp;<input type="text" name="<!--{$key3}-->" value="<!--{$arrForm[$key3].value|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="input-mini required">
    </div>
  </div>
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--><!--{$arrErr[$key3]}--></div>
      <!--{/if}-->
      <input id="customer-fax" type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="input-mini">&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="input-mini">&nbsp;-&nbsp;<input type="text" name="<!--{$key3}-->" value="<!--{$arrForm[$key3].value|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="input-mini">
    </div>
  </div>
</fieldset>
<!--{if $flgFields > 1}-->
<fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
      <!--{/if}-->
      <input id="customer-email" type="email" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" class="input-block required" x-autocompletetype="email">
      <input type="email" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" x-autocompletetype="email" class="required">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
      <!--{/if}-->
      <input id="customer-phonemail" type="email" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|h}-->" style="display:block; margin-bottom:9px;" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" class="top">
      <input type="email" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|h}-->" maxlength="<!--{$smarty.const.MTEXT_LEN}-->">
      <span class="help-inline">確認のため2度入力してください。</span>
    </div>
  </div>
  <!--{/if}-->
...
<fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <!--{/if}-->
      <input id="customer-password" type="password" name="password" value="<!--{$arrForm.password.value|h}-->" maxlength="<!--{$smarty.const.PASSWORD_MAX_LEN}-->" style="margin-bottom:9px;" class="required">
      <span class="help-inline">半角英数字<!--{$smarty.const.PASSWORD_MIN_LEN}-->～<!--{$smarty.const.PASSWORD_MAX_LEN}-->文字でお願いします。（記号不可）</span>
      <input type="password" name="password02" value="<!--{$arrForm.password02.value|h}-->" maxlength="<!--{$smarty.const.PASSWORD_MAX_LEN}-->" class="required">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <label class="inline" for="customer-answer">答え
        <input id="customer-answer" type="text" name="reminder_answer" value="<!--{$arrForm.reminder_answer.value|h}-->" class="required">
      </label>
    </div>
  </div>
</fieldset>
<fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <!--{/if}-->
      <label class="radio" for="html"><input type="radio" name="mailmaga_flg" value="1" id="html" <!--{if $arrForm.mailmaga_flg.value eq 1}--> checked="checked" <!--{/if}--> class="required">HTMLメール＋テキストメールを受け取る</label>
      <label class="radio" for="text"><input type="radio" name="mailmaga_flg" value="2" id="text" <!--{if $arrForm.mailmaga_flg.value eq 2}--> checked="checked" <!--{/if}--> class="required">テキストメールを受け取る</label>
      <label class="radio" for="no"><input type="radio" name="mailmaga_flg" value="3" id="no" <!--{if $arrForm.mailmaga_flg.value eq 3}--> checked="checked" <!--{/if}--> class="required">受け取らない</label>
    </div>
  </div>
</fieldset>
<!--{/if}-->
